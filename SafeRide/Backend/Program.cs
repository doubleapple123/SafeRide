...
builder.Services.AddCors(options =>
{
    options.AddPolicy(name: MyAllowSpecificOrigins,
                      builder =>
                      {
                          builder.WithOrigins("https://oriontang00.github.io");
                      });
});
...
//Hazard hazard = new Hazard(HazardType.Obstruction, 70, 50, "asfgasgrwt", "CA", 92510, "Tustin", DateTime.Now, 1);
//Console.WriteLine(hazardDAO.Report(hazard));

//List<Hazard> hazardList = new List<Hazard>();

//hazardList = hazardDAO.GetAllValidHazards();

//foreach (var i in hazardList)
//{
//    Console.Write(i.Latitude + " ");
//    Console.Write(i.Longitude + " ");
//    Console.Write(i.Type + " ");
//    Console.Write(i.TimeReported + " ");
//    Console.Write(i.ReportedBy + " ");
//    Console.Write(i.Expired + " ");
