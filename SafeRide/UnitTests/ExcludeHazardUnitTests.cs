...
namespace SRUnitTests
{
	public class ExcludeHazardUnitTests
	{
		...
		//[Theory]
		//[InlineData(-74.002917, 40.73992, 0, 5, 5)] // querying the test data for hazard type of 0 around the given coordinate should return a total 5 hazard coordinates
		//public void GetByTypeInRadius(double searchY, double searchX, int hazardType, double radiusInMiles, int expected)
		//{
		//	HazardDAO hazardDAO = new HazardDAO();
		//	Dictionary<double, double> results = hazardDAO.GetByTypeInRadius(hazardType, searchY, searchX, radiusInMiles);
